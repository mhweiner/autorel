...
program
    ...
    .option('--run <value>', 'Command to run after the release is successful, or before tag/release when combined with --run-before-release. (arg: run)')
    .option('--run-before-release', 'Run --run after the version is determined but before creating the git tag, GitHub release, or npm publish. (arg: runBeforeRelease)')
